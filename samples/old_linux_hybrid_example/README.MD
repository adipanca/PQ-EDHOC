...
```
* NOTE: If the message size is lower than the COAP_DEFAULT_MTU that is seeting as 1152, the message will not be sent it with  block-wise transfer mechanism, if you want to set MAX_PAYLOAS_SIZE to always be 512 you should set and send messages aroun 900 the COAP_DEFAULT_MTU from /home/lidia/zephyrproject/zephyr/PQ-uEDHOC-new/externals/libcoap/include/coap3/coap_pdu.h should be reduce. 
